Public Class frmDemoVersionRegistrieren
    ...
    Private Sub btnRegisterJTLBridge_Click(sender As System.Object, e As System.EventArgs) Handles btnRegisterJTLBridge.Click
        ...
        MessageBox.Show("JTL Lagerbestand Report wurde erfolgreich registriert!" & vbCrLf & vbCrLf & "Sie können das Programm jetzt weiter benutzen!", "JTL Lagerbestand Report Registration", MessageBoxButtons.OK, MessageBoxIcon.Information)
        bRegistered = True
        Me.Close()
    End Sub
