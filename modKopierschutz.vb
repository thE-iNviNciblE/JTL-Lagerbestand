...
Module modKopierschutz
    ...
    Public strVersionsNummer As String = "2.0.1"
    Public pgrUpdater_global As ProgressBar
    Public strItemCurrent_bild As String = ""
    ...
    Public Function setMainWindowTitle(ByVal strFormularName As String, ByVal frmForm As Form) As Boolean
        Try
            If strFormularName.Length > 0 Then
                frmForm.Text = "JTL Lager Report - " & strFormularName & " - Mandant: " & My.Settings.mandant_letzter_name & " v." & strVersionsNummer
            Else
                frmForm.Text = "JTL Lager Report - Mandant: " & My.Settings.mandant_letzter_name & " v." & strVersionsNummer
            End If
    ...
    Public Function getHTTPResponseMessage(ByVal strURL As String, ByVal mModus As mgetUpdaterMessage, ByVal bMessage As Boolean) As String()
        ...
        Try
            ...
            Select Case mModus
                ...
                Case mgetUpdaterMessage.getItemDetails
                    'MessageBox.Show(strServerInfo(0))
                    Dim strSplit() As String = strServerInfo(0).Split("~~")
                    strItemCurrent_bild = strSplit(4)
                    'Exit Function
    ...
    Public Function setUpdateCheck(ByVal pgrUpdate As ProgressBar, ByVal lblUpdater As Label) As Boolean
        ...
        strMessage = "https://api.bludau-media.de/SafeSandy/Download.php?version=" & strVersionsNummer & "&name=JTL%20LagerReport&key=" & gbl_KeyCode & "&programID=12&versionsnummer=" & strVersionsNummer
    ...
    Public Function Encrypt(ByVal plainText As String) As String
        ...
        Dim inputInBytes() As Byte = utf8encoder.GetBytes(plainText & "JTL Lagerbestand Report")
