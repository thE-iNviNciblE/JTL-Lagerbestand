Public Class frmUpdater
    ...
    Private Sub frmUpdater_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        ...
        Dim strServerInfo() As String = getHTTPResponseMessage("https://api.bludau-media.de/SafeSandy/Update.php?key=" & gbl_KeyCode & "&programID=12&versionsnummer=" & strVersionsNummer, mgetUpdaterMessage.getProgramUpdateCheck, True)
    ...
    Private Sub btnDownload_Click(sender As System.Object, e As System.EventArgs) Handles btnDownload.Click
        ...
        If MessageBox.Show("Möchten Sie das Update von JTL Lagerbestand Report jetzt installieren?", "JTL Lagerbestand Report Update Installation", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
